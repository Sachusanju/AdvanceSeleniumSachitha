...
//To verify that user is able to enter maximun of 2 "."  in email textfield.
public class TC_FT_Login_010 {
	...
	public static void main(String[] args) {
		...
		String actualEmailData = "br..sachitha@gmail.com";
		...
		// Step 4:Enter maximun of 2 "." in email textfield for Email textfield.

		WebElement emailTextBox = driver.findElement(By.xpath("//input[@id='Email']"));
		emailTextBox.sendKeys("br..sachitha@gmail.com");
		...
		if (actualEmailData.equals(expectedEmailData)) {
			System.out.println("User enter invalid email data.");
			WebElement messageForInvalidEmail = driver
					.findElement(By.xpath("//span[contains(text(),'Please enter a valid email address.')]"));
