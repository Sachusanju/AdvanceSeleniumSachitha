...
// To verify that user is able to leave empty space in email textfield.
public class TC_FT_Login_008 {
	...
	public static void main(String[] args) {
		...
		if (expectedEmailData.isBlank()) {
			...
			System.out.println("User is not able to leave Email text box empty");
		}
