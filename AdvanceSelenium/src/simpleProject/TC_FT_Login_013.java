...
//To verify that user is able to leave empty space in password textfield and able to login to their account.
public class TC_FT_Login_013 {
	...
	public static void main(String[] args) {
		...
		// Step-5:Leave empty space to Password Text field and click on login button
		...
		if (actualEmailData.equals(login_acct)) {
			System.out.println("User is able to enter valid password and login to their account.");

		} 
		else {
			System.out.println("User is not able to login to their account with valid password.");
		}
