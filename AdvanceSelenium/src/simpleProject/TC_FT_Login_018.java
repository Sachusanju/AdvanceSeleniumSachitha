...
//To verify that user is able to enter only alphabets in Password textfiled.
public class TC_FT_Login_018 {
	public static void main(String[] args) {
		...
		String actualEmailData = "btsachitha1278@gmail.com";
		...
		emailTextBox.sendKeys("btsachitha1278@gmail.com");
		...
		passwordTextField.sendKeys("Sanjana");
