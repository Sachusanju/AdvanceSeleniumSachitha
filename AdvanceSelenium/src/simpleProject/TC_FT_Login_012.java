...
//To verify if a valid password is allowing users to successfully log in to their account.
public class TC_FT_Login_012 {
	...
	public static void main(String[] args) {
		...
		// Step-5:Enter valid data to Password Text field and click on login button
		...
		if (actualEmailData.equals(login_acct)) {
			...
			System.out.println("User is not able to login their account with valid password.");
		}
