...
//To verify that user is able to enter any number of  "_" special character in email textfield.
public class TC_FT_Login_002 {
	...
	public static void main(String[] args) 
	{
		...
		String actualEmailData = "_b_r_sachitha@gmail.com";
		...
		//Step 4:Enter valid email containing special characters '_' to Email textfield.
		WebElement emailTextBox = driver.findElement(By.xpath("//input[@id='Email']"));
		emailTextBox.sendKeys("_b_r_sachitha@gmail.com");
