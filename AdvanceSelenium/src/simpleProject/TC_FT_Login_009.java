...
public class TC_FT_Login_009 {

//To verify that user is able to enter special characters in sub-domain.
	public static void main(String[] args) {
		...
		// Step 4:Enter special characters in sub-domain for Email textfield.
