...
//To verify that user is able to login by entering valid data to email textfield and invalid data to password textfield.
public class TC_IT_Login_003 {
	...
	public static void main(String[] args) 
	{
		...
		password_textfield.sendKeys("Sanjana");
