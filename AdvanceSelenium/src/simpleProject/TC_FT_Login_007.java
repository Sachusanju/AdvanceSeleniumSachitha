...
//To verify that user is able to enter invalid format for email textfield.
public class TC_FT_Login_007 {
	...
	public static void main(String[] args) {
		...
		String actualEmailData = "gmail.com@brsachitha";
		...
		// Step 4:Enter invalid format for Email textfield.
		WebElement emailTextBox = driver.findElement(By.xpath("//input[@id='Email']"));
		emailTextBox.sendKeys("gmail.com@brsachitha");
